...
Все это из-за того, что из коробки у нас устаноновлены ~~за каким-то х\_уем~~ иксы (x11-core). Удаляем все это:
...
Сохраняемся. Вы великолепны! Теперь вы можете подключиться к своему серверу __не__ из локальной сети:
