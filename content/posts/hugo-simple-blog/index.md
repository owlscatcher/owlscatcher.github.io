...
В этой заметке рассмотри как нам поднять, захостить и настроить деплой нашего 
...
настройка будет аналогичная, только вместо `.zshrc` будем `.bashrc`.
