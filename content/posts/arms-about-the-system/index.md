---
title: "ARMStrong: знакомство с системой"
...
ARMStrong (*англ.: Automated Radiation Monitoring System*) — автоматизированная система радиационного контроля, (далее 
**СРК**) включающая в себя комплекс средств, призванных осуществлять радиационный контроль, в целях снижения 
травматизма, предупреждения предаварийных ситуация и недопущения развития аварийных сценариев.
...
![Архитектурная схема 2-го и 3-го уровня](arch_sheme_2.png)
...
![Печатная плата АСРК](asrc_back.png)
...
### 2.2 Предоставляемые возможности
...
![ARMStrong сервер](arms-server.png)
